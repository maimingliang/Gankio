...
public class QianduanFragment extends Fragment implements IMainView{
    ...
    public static QianduanFragment newInstance() {
        QianduanFragment fragment = new QianduanFragment();
